...
export const KB_PAGE_NAMESPACES_HINT =
  'projects/<repoSlug>/checklists/、projects/<repoSlug>/source-docs/、projects/<repoSlug>/learnings/、projects/<repoSlug>/ch_*/learnings/、projects/<repoSlug>/ch_*/t_*.md、projects/<repoSlug>/ch_*/review/、projects/<repoSlug>/reviews/<topic>-<ymd>/';
