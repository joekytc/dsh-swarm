window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function applyTo(state, ev) {
		  ...
		  switch (ev.kind) {
		    ...
		    case "task/archived": {
		      ...
		      if (ev.kind === "task/failed") updated.attempts = t.attempts + 1;
		...
		function WorkflowRail(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh-kb-rail", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-kb-filters", role: "group", "aria-label": "\u6309\u94FE\u8DEF\u72B6\u6001\u7B5B\u9009", children: CHAIN_FILTERS.map((f) => {
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-kb-rail__list", role: "list", "aria-label": "\u4EFB\u52A1\u94FE\u8DEF", children: visible.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-kb-empty", role: "status", children: searching ? "\u65E0\u5339\u914D\u94FE\u8DEF" : "\u6682\u65E0\u770B\u677F\u4EFB\u52A1\uFF0C\u8F93\u5165 /plan: \u5F00\u542F\u65B0\u94FE\u8DEF" }) : visible.map((view) => {
		      ...
		      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: `dsh-kb-chain dsh-kb-chain--${view.chain.status}`, children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
		          "button",
		          {
		            ...
		            children: [
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh-kb-chain__chevron", "aria-hidden": "true" }),
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh-kb-chain__name", children: view.chain.title }),
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh-kb-chain__meta", children: [
		                done,
		                "/",
		                view.tasks.length
		              ] })
		        ...
		        (blocked || view.blockedSummary) && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-kb-chain__warning", children: summary }),
		        view.audit && !view.audit.confirmed && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh-kb-chain__warning dsh-kb-chain__audit", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
		            "\u26A0 \u4E3B agent \u7591\u4F3C\u8D8A\u6743\u5199\u5DE5\u4F5C\u533A\u4EA7\u7269\uFF08",
		            view.audit.evidenceCount,
		            " \u6761\u7EBF\u7D22\uFF09\uFF0C\u6700\u7EC8\u6C47\u62A5\u5DF2\u963B\u585E\uFF0C\u8BF7\u6838\u5BF9\u4EA7\u7269\u5F52\u5C5E"
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh-kb-audit-confirm", onClick: () => props.onConfirmAudit?.(view.chain.id), children: "\u786E\u8BA4\u4EA7\u7269\u5F52\u5C5E" })
		        ] }),
		        expanded && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ol", { className: "dsh-kb-nodes", children: (matched.length > 0 ? matched : view.tasks).map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: `dsh-kb-node dsh-kb-node--${item.lineState}`, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BoardCard, { view: item, onOpen: props.onOpenTask }) }, item.task.id)) })
		      ] }, view.chain.id);
		    }) })
		  ] });
		}
		...
		function TaskDrawer(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-kb-detail", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("header", { className: "dsh-kb-detail__header", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", "aria-label": "\u8FD4\u56DE\u4EFB\u52A1\u5217\u8868", onClick: props.onClose, children: "\u2190" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `dsh-kb-profile dsh-kb-profile--${task.assignee}`, children: task.assignee.toUpperCase() }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-kb-detail__identity", children: [
		      ...
		      props.unreadCount ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { type: "button", className: "dsh-kb-unread", onClick: () => setTab("timeline"), children: [
		        props.unreadCount,
		        " \u6761\u65B0\u66F4\u65B0"
		      ] }) : null,
		      !props.readOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-kb-detail__actions", children: [
		        task.status === "running" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => arm("complete"), children: "\u5B8C\u6210" }),
		        task.status === "running" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => arm("block"), children: "\u963B\u585E" }),
		        task.status === "blocked" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => props.onAction({ type: "unblock", taskId: task.id }), children: "\u89E3\u9664\u963B\u585E" }),
		        task.status === "failed" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => props.onAction({ type: "retry", taskId: task.id }), children: "\u91CD\u8BD5" }),
		        ["done", "failed", "blocked"].includes(task.status) && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", "data-confirming": pending?.kind === "archive" || void 0, onClick: pending?.kind === "archive" ? submitArchive : () => arm("archive"), children: pending?.kind === "archive" ? "\u786E\u8BA4\u5F52\u6863" : "\u5F52\u6863" }),
		        pending?.kind === "complete" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-kb-action-form", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { "aria-label": "\u4EA4\u63A5\u6458\u8981", value: pending.value, onChange: (e) => setPending({ kind: "complete", value: e.target.value }), placeholder: "\u4EA4\u63A5\u6458\u8981" }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !pending.value.trim(), onClick: () => submitPayload("complete"), children: "\u786E\u8BA4\u5B8C\u6210" }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => setPending(null), children: "\u53D6\u6D88" })
		        ] }),
		        pending?.kind === "block" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh-kb-action-form", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { "aria-label": "\u963B\u585E\u539F\u56E0", value: pending.value, onChange: (e) => setPending({ kind: "block", value: e.target.value }), placeholder: "\u963B\u585E\u539F\u56E0" }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !pending.value.trim(), onClick: () => submitPayload("block"), children: "\u786E\u8BA4\u963B\u585E" }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => setPending(null), children: "\u53D6\u6D88" })
		        ] })
		      ] })
		    ] }),
		    props.actionError?.taskId === task.id && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-kb-action-error", role: "alert", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
		        "\u64CD\u4F5C\u5931\u8D25\uFF1A",
		        props.actionError.message
		      ] }),
		      props.onRetry && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: props.onRetry, children: "\u91CD\u8BD5\u64CD\u4F5C" })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { role: "tablist", "aria-label": "\u4EFB\u52A1\u8BE6\u60C5", children: TABS.map(([id, label]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", role: "tab", "aria-selected": tab === id, onClick: () => setTab(id), children: label }, id)) }),
		    tab === "overview" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { role: "tabpanel", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Workflow \u4E0A\u4E0B\u6587" }),
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("dl", { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "Profile" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("dd", { children: [
		          task.assignee.toUpperCase(),
		          " / ",
		          ROLE_NAME[task.assignee]
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "\u72B6\u6001" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: statusLabelOf(task.status) }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "Chain" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: chain.title }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "\u4F18\u5148\u7EA7" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: task.priority }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "\u5FC3\u8DF3" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: task.heartbeats.length }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "\u4F9D\u8D56" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: props.parentTasks && props.parentTasks.length > 0 ? props.parentTasks.map((p) => p.title).join(" \u2192 ") : "\u65E0" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "\u91CD\u8BD5" }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("dd", { children: [
		          task.attempts,
		          " \u6B21",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: task.body || "\u65E0\u9644\u52A0\u4EFB\u52A1\u63CF\u8FF0" })
		    ] }),
		    tab === "timeline" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("section", { role: "tabpanel", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ol", { children: timeline.map((event) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("code", { children: event.kind }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
		        "seq ",
		        event.seq,
		        " \xB7 ",
		    ...
		    tab === "handoff" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { role: "tabpanel", children: [
		      props.parentTasks && props.parentTasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "\u7236\u4EFB\u52A1\u539F\u6587" }),
		        props.parentTasks.map((p) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: p.title }),
		          p.body ? `\uFF1A${p.body}` : "\uFF08\u65E0\u6B63\u6587\uFF09"
		        ] }, p.id))
		      ] }),
		      props.parentHandoffs.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "\u7236\u4EFB\u52A1\u4EA4\u63A5" }),
		        props.parentHandoffs.map((h, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: h.summary }),
		          " ",
		          formatValue(h.metadata)
		        ] }, i))
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "\u5F53\u524D\u4EFB\u52A1\u4EA4\u63A5" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: handoff?.summary ?? "\u5F53\u524D\u4EFB\u52A1\u5C1A\u65E0\u4EA4\u63A5" }),
		      handoff && Object.entries(handoff.metadata).map(([key, value]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: key }),
		        ": ",
		        formatValue(value)
		      ] }, key))
		    ] }),
		    tab === "spec" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { role: "tabpanel", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Problem" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.problem ?? "\u65E0\u89C4\u683C\u5361" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Solution" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.solution ?? "\u65E0" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "User stories" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.user_stories.join("; ") || "\u65E0" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Implementation decisions" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.impl_decisions.join("; ") || "\u65E0" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Testing" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.testing ?? "\u65E0" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "Out of scope" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: specCard?.sections.out_of_scope ?? "\u65E0" }),
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { children: "\u9644\u4EF6" }),
		      specCard && specCard.attachments.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { className: "dsh-kb-spec-attachments", children: specCard.attachments.map((a) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dsh-kb-spec-attachment__kind", children: a.kind }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: a.name }),
		        " ",
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("code", { children: a.ref })
		      ] }, `${a.name}-${a.ref}`)) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "\u65E0\u9644\u4EF6" })
		    ] }),
		    tab === "comments" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { role: "tabpanel", children: [
		      comments.map((event) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: event.author }),
		        " ",
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("time", { dateTime: new Date(event.at).toISOString(), children: formatTime(event.at) }),
		        ": ",
		        String(event.payload["body"])
		      ] }, event.seq)),
		      !props.readOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		        "input",
		        {
		          "aria-label": "\u6DFB\u52A0\u8BC4\u8BBA",
		          onKeyDown: (e) => {
		...
		function KanbanBoard(props) {
		  ...
		  const [statusFilter, setStatusFilter] = (0, import_react3.useState)(/* @__PURE__ */ new Set());
		  const [selectedId, setSelectedId] = (0, import_react3.useState)(() => history.state?.kanbanTaskId ?? null);
		  const [failedAction, setFailedAction] = (0, import_react3.useState)(null);
		  const listRef = (0, import_react3.useRef)(null);
		  const saved = (0, import_react3.useRef)({ collapsed: [], scrollTop: 0 });
		  const snapshotRef = (0, import_react3.useRef)(props.snapshot);
		  snapshotRef.current = props.snapshot;
		  const detailOpenedSeq = (0, import_react3.useRef)(null);
		  ...
		  const views = (0, import_react3.useMemo)(
		  ...
		  if (!board) {
		    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-kb-loading", children: "\u52A0\u8F7D\u770B\u677F\u2026" });
		  }
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-kb-tab-body", ref: listRef, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-kb-toolbar", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		      "input",
		      {
		        "aria-label": "\u641C\u7D22\u94FE\u8DEF",
		        value: query,
		...
		function ConnectionBanner(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `dsh-kb-banner dsh-kb-banner--${props.connection}`, role: "status", children: [
		    label,
		    props.connection === "error" && props.lastSuccessAt ? ` \xB7 \u6700\u540E\u6210\u529F ${new Date(props.lastSuccessAt).toLocaleTimeString()}` : "",
		    props.connection === "error" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "dsh-kb-banner__retry", onClick: props.onRetry, children: "\u91CD\u8BD5" })
		  ] });
		}
		...
		function KanbanTab(props = {}) {
		  const own = (0, import_react4.useMemo)(() => props.store ?? createBoardStore(), [props.store]);
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-kb-tab", role: "region", "aria-label": "\u770B\u677F", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ConnectionBanner, { connection: snapshot.connection, lastSuccessAt: snapshot.lastSuccessAt, onRetry: () => void own.retry() }),
		    snapshot.board ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(KanbanBoard, { snapshot, postAction: (action) => own.postAction(action) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-kb-loading", children: "\u52A0\u8F7D\u770B\u677F\u2026" })
		  ] });
		}
		...
		function apply(ctx) {
		  ...
		  if (typeof document !== "undefined") {
		    style = document.head.querySelector("style[data-dsh-kanban]");
		    if (!style) {
