    ...
    registry.register(defineTool({
        ...
        async execute(args, exec) {
            ...
            if (route.kind === 'plan') {
                ...
                return { kind: 'plan', chainId: route.chainId, specCardId: route.specCardId, guidance: MATTPOCOCK_PLANNING_GUIDANCE + KANBAN_HANDOFF_RULE };
            }
            ...
            if (r.ok)
                return { kind: 'openspec', chainId, specCardId: cardId, approved: true, guidance: KANBAN_HANDOFF_RULE };
            return { kind: 'openspec', chainId, specCardId: cardId, approved: false, missing: r.missing, guidance: r.guidance };
        },
    }));
