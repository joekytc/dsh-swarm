window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ConfigSection({ fetchImpl, close }) {
		  ...
		  const state = (0, import_react7.useSyncExternalStore)(store.subscribe, store.get);
		  const [draft, setDraft] = (0, import_react7.useState)(null);
		  (0, import_react7.useEffect)(() => {
		    void store.load().then(() => setDraft(store.get().effective));
		  }, [store]);
		  if (!draft) return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-kb-config", children: "\u52A0\u8F7D\u4E2D\u2026" });
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dsh-kb-config", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "dsh-kb-config__card", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { children: "wikiVault" }),
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "dsh-kb-config__label", children: "baseUrl" }),
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-kb-config__help", children: "llm-wiki \u77E5\u8BC6\u5E93\u5916\u94FE HTTP \u5730\u5740\uFF08\u5982 http://192.168.122.111:3000\uFF09\uFF1B\u7559\u7A7A\u5219\u4F7F\u7528\u672C\u5730 llm-wiki \u515C\u5E95" }),
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "dsh-kb-config__label", children: "pagePrefix" }),
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
		        "input",
		        {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-kb-config__help", children: "llm-wiki \u9875\u9762\u8DEF\u5F84\u524D\u7F00\uFF08\u5982 projects/\uFF09" })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "dsh-kb-config__card", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { children: "\u6A21\u578B\u94FE" }),
		      ROLES.map((r) => {
		        ...
		        return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dsh-kb-config__role", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("strong", { children: r }),
		          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
		            "select",
		            {
		              ...
		              children: [
		                ...
		                state.catalog.providers.map((p) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: p.id, children: p.name }, p.id))
		              ]
		            }
		          ),
		          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
		            "select",
		            {
		              ...
		              children: [
		                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "", children: "\u9009\u62E9\u6A21\u578B" }),
		                providerModels.map((x) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: x.id, children: x.name }, x.id))
		              ]
		            }
		          ),
		          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
		            "select",
		            {
		              ...
		              children: [
		                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "", children: "\u8DDF\u968F\u9ED8\u8BA4" }),
		                efforts.map((x) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: x.id, children: x.name }, x.id))
		              ]
		            }
		          ),
		          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-kb-config__src", children: state.sources[`roles.models.${r}.model`] === "override" ? "\u5DF2\u8986\u76D6" : "\u7EE7\u627F" })
		        ] }, r);
		      })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-kb-config__footer", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { onClick: () => {
		      void store.reset().then((r) => setDraft(r.effective));
		    }, children: "\u91CD\u7F6E" }) }),
		    state.error && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-kb-config__error", children: state.error })
		  ] });
		}
		...
		// client/config.css
		var config_default = ".dsh-kb-config { padding: 16px; font-size: 13px; }\n.dsh-kb-config__card { border: 1px solid var(--dsw-alias-border, #333); border-radius: 16px; padding: 16px; margin-bottom: 16px; }\n.dsh-kb-config__card h3 { margin: 0 0 12px; }\n.dsh-kb-config__help { color: var(--dsw-alias-text-secondary, #888); font-size: 12px; display: block; }\n.dsh-kb-config__role { display: grid; grid-template-columns: 32px 1fr 1fr 1fr; gap: 8px; margin-bottom: 8px; align-items: center; }\n.dsh-kb-config__footer { display: flex; justify-content: flex-end; }\n.dsh-kb-config__error { color: var(--dsw-alias-danger, #e5484d); }\n";
